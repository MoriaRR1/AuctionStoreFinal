create sequence item_id_seq start 109 increment 1;
...
(
    ...
    item_base_notes   varchar(255) not null,
    item_middle_notes varchar(255) not null,
    item_top_notes    varchar(255) not null,
    item_gender        varchar(255) not null,
    item_title          varchar(255) not null,
    itemer               varchar(255) not null,
    price                  int4 not null,
...
alter table if exists orders_items
    add constraint FK9c3l5vucp0yrrwpc0v8vk8knt foreign key (items_id) references items;
alter table if exists orders_items
...
alter table if exists users_item_list
    add constraint FK9neiuundys2yde15o8tcybbvw foreign key (item_list_id) references items;
alter table if exists users_item_list
