package auctionstore.constants;

public class Pages {
    public static final String ADMIN_ITEMS = "admin-items";
    public static final String ADMIN_EDIT_ITEM = "admin-edit-item";
    public static final String ADMIN_ADD_ITEM = "admin-add-item";
    public static final String USER_ADD_ITEM = "user-add-item";
