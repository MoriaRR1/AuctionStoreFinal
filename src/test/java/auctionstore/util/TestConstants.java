...
public class TestConstants {
    ...
    public static final String ITEM_TITLE = "Boss Bottled Night";
    public static final String ITEMER = "Hugo Boss";
    public static final Integer YEAR = 2010;
    public static final String COUNTRY = "Germany";
    public static final String ITEM_GENDER = "male";
    public static final String ITEM_TOP_NOTES = "Birch leaf, Lavender";
    public static final String ITEM_MIDDLE_NOTES = "Cardamom, Jasmine, African violet";
    public static final String ITEM_BASE_NOTES = "Salmwood, Musky notes, Sandalwood";
